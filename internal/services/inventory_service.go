...
type DeltaParams = appinventory.DeltaParams

type deltaResult = appinventory.DeltaResult
...
type inventoryService struct {
	...
	alertEmails   []string
	commands      *appinventory.Commands
	queries       *appinventory.Queries
}
...
func NewInventoryService(
	...
	return &inventoryService{
		...
		commands:      appinventory.NewCommands(repo),
		queries:       appinventory.NewQueries(repo, postgres.RevenueOrderStatuses()),
	}
}
