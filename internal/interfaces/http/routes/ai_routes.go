...
func SetupAiRoutes(public *gin.RouterGroup, protected *gin.RouterGroup, ctrl *handlers.Container) {
	...
	public.POST("/ai/room-preview", ctrl.Ai.RoomPreview)
	...
	public.POST("/ai/negotiation", ctrl.Ai.Negotiation)
	public.POST("/ai/compatibility-check", ctrl.Ai.CompatibilityCheck)
	...
	protected.POST("/ai/personal-shopping-agent", ctrl.Ai.PersonalShoppingAgent)
	...
	protected.POST("/ai/replenishment-reminders", ctrl.Ai.ReplenishmentReminders)
	protected.POST("/ai/household-shopping", ctrl.Ai.HouseholdShopping)
