...
func (r *Router) Setup() {
	...
	v1 := r.engine.Group(constants.APIVersionV1)
	{
		...
		SetupPromotionRoutes(protected, r.handlerContainer)
		SetupEmailMarketingRoutes(public, protected, r.handlerContainer)
		...
		SetupBlogRoutes(public, protected, r.handlerContainer)
		SetupPrivacyRuleRoutes(public, protected, r.handlerContainer)
