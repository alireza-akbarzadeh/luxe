...
func (ctrl *InventoryHandler) GetOverview(c *gin.Context) {
...
func (ctrl *InventoryHandler) List(c *gin.Context) {
...
func (ctrl *InventoryHandler) Adjust(c *gin.Context) {
...
func (ctrl *InventoryHandler) BulkAdjust(c *gin.Context) {
...
func (ctrl *InventoryHandler) ListHistory(c *gin.Context) {
...
func (ctrl *InventoryHandler) ListRecent(c *gin.Context) {
	limit := 10
