...
func (pc *PushHandler) GetVapidPublicKey(c *gin.Context) {
...
func (pc *PushHandler) RegisterPushSubscription(c *gin.Context) {
...
func (pc *PushHandler) DeletePushSubscription(c *gin.Context) {
	userID, ok := middleware.GetUserID(c)
	if !ok {
		utils.UnauthorizedResponse(c, constants.ErrUnauthorized)
		return
...
func (pc *PushHandler) SendTestPush(c *gin.Context) {
	userID, ok := middleware.GetUserID(c)
	if !ok {
		utils.UnauthorizedResponse(c, constants.ErrUnauthorized)
		return
