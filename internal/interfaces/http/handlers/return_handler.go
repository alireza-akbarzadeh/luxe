...
// @Router       /returns [post]
func (ctrl *ReturnHandler) CreateReturn(c *gin.Context) {
...
func (ctrl *ReturnHandler) GetMyReturns(c *gin.Context) {
	userID, ok := middleware.GetUserID(c)
	if !ok {
		utils.UnauthorizedResponse(c, constants.ErrUnauthorized)
		return
...
func (ctrl *ReturnHandler) GetReturn(c *gin.Context) {
	userID, ok := middleware.GetUserID(c)
	if !ok {
		utils.UnauthorizedResponse(c, constants.ErrUnauthorized)
		return
...
func (ctrl *ReturnHandler) ListReturnsAdmin(c *gin.Context) {
...
func (ctrl *ReturnHandler) GetReturnAdmin(c *gin.Context) {
	returnID, ok := parseUintParam(c, "id")
	if !ok {
		return
	}
...
func (ctrl *ReturnHandler) PerformReturnTransition(c *gin.Context) {
	returnID, ok := parseUintParam(c, "id")
	if !ok {
		return
	}
