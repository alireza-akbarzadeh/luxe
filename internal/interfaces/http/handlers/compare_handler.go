...
// @Router       /compare [post]
func (ctrl *CompareHandler) CompareProducts(c *gin.Context) {
...
// @Router       /compare [get]
func (ctrl *CompareHandler) GetCompareList(c *gin.Context) {
...
// @Failure      400 {object} utils.Response
// @Router       /compare [put]
func (ctrl *CompareHandler) SyncCompareList(c *gin.Context) {
	userID, ok := middleware.GetUserID(c)
	if !ok {
		utils.UnauthorizedResponse(c, constants.ErrUnauthorized)
		return
