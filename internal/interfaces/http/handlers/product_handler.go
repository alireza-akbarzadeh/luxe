...
func (ctrl *ProductHandler) Create(c *gin.Context) {
...
func (ctrl *ProductHandler) Update(c *gin.Context) {
...
func (ctrl *ProductHandler) Delete(c *gin.Context) {
	id, err := strconv.ParseUint(c.Param("id"), 10, 64)
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, "invalid product id")
		return
...
func (ctrl *ProductHandler) GetOne(c *gin.Context) {
...
// @Failure      500 {object} utils.Response
// @Router       /products [get]
func (ctrl *ProductHandler) List(c *gin.Context) {
...
func (ctrl *ProductHandler) BulkCreate(c *gin.Context) {
...
func (ctrl *ProductHandler) BulkDelete(c *gin.Context) {
...
func (ctrl *ProductHandler) GetRelated(c *gin.Context) {
	id, err := strconv.ParseUint(c.Param("id"), 10, 64)
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, "invalid product id")
		return
...
func (ctrl *ProductHandler) GetProductSuggestions(c *gin.Context) {
...
func (ctrl *ProductHandler) GetAvailableTransitions(c *gin.Context) {
...
func (ctrl *ProductHandler) PerformTransition(c *gin.Context) {
	productID, ok := parseUintParam(c, "id")
	if !ok {
		return
	}
