...
func (c *Commands) Create(ctx context.Context, req *dto.CreateCollectionRequest, slug string) (*models.Collection, error) {
	...
	collection := BuildCreateModel(req, slug)
...
// Update persists collection field changes.
func (c *Commands) Update(ctx context.Context, collection *models.Collection) error {
	return c.repo.Save(ctx, collection)
}
