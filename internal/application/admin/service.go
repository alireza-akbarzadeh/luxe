...
func (s *Service) GetBusinessInsights(ctx context.Context, filters dto.AdminBusinessInsightsFilters) (*dto.AdminBusinessInsightsResponse, error) {
	return s.queries.GetBusinessInsights(ctx, filters)
}
