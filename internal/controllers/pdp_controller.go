...
func NewPdpController(pdp services.PdpServiceInterface, product services.ProductServiceInterface) *PdpController {
	return &PdpController{pdpService: pdp, productService: product, validate: validator.New()}
}

func (ctrl *PdpController) resolveProductID(c *gin.Context) (uint, bool) {
...
func (ctrl *PdpController) GetPriceHistory(c *gin.Context) {
...
func (ctrl *PdpController) GetAlternatives(c *gin.Context) {
	productID, ok := ctrl.resolveProductID(c)
	if !ok {
		return
	}
...
func (ctrl *PdpController) GetQuestions(c *gin.Context) {
	productID, ok := ctrl.resolveProductID(c)
	if !ok {
		return
	}
...
func (ctrl *PdpController) CreateQuestion(c *gin.Context) {
...
func (ctrl *PdpController) CreateAnswer(c *gin.Context) {
	userID, ok := middleware.GetUserID(c)
	if !ok {
		utils.UnauthorizedResponse(c, constants.ErrUnauthorized)
		return
...
func (ctrl *PdpController) SubscribeStock(c *gin.Context) {
	userID, ok := middleware.GetUserID(c)
	if !ok {
		utils.UnauthorizedResponse(c, constants.ErrUnauthorized)
		return
...
func (ctrl *PdpController) UnsubscribeStock(c *gin.Context) {
	userID, ok := middleware.GetUserID(c)
	if !ok {
		utils.UnauthorizedResponse(c, constants.ErrUnauthorized)
		return
...
func (ctrl *PdpController) GetStockStatus(c *gin.Context) {
	userID, ok := middleware.GetUserID(c)
	if !ok {
		utils.UnauthorizedResponse(c, constants.ErrUnauthorized)
		return
