...
// CollectionController handles collection HTTP requests.
...
func NewCollectionController(collectionService services.CollectionServiceInterface) *CollectionController {
