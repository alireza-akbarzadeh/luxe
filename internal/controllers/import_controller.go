...
func NewImportController(svc services.ImportServiceInterface) *ImportController {
	return &ImportController{importService: svc}
}
...
func (ctrl *ImportController) ImportProducts(c *gin.Context) {
...
func (ctrl *ImportController) ImportCategories(c *gin.Context) {
	fh, err := c.FormFile("file")
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, "file is required (form field: file)")
		return
...
func (ctrl *ImportController) DownloadTemplate(c *gin.Context) {
